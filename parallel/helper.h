...
double ***matrix_3d(int nrl, int nrh, int ncl, int nch, int nzl, int nzh);
...
void free_matrix_3d(double ***m, int nrl, int nrh, int ncl, int nch, int nzl, int nzh);
...
void init_matrix_3d( double ***m, int nrl, int nrh, int ncl, int nch, int nzl, int nzh, double a);
